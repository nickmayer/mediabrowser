...
namespace HttpServer.Mvc
{
    ...
    public class BootStrapper
    {
        ...
        {
            _server = server;
            _server.ViewProvider.Add(_resources);
        }
        ...
        public void LoadControllers(Assembly assembly)
        {
            ...
            foreach (Type type in assembly.GetTypes())
            {
                ...
                _resources.AddFilesInFolder("/" + instance.ControllerName + "/", type.Assembly, type.Namespace + ".Views");
            }            
        ...
        public void LoadEmbeddedViews(Assembly assembly)
        {
            foreach (var resourceName in assembly.GetManifestResourceNames())
            {
                ...
                {
                    _resources.AddFile(controller + "/" + actionName + "." + extension, assembly, resourceName);
                    continue;
                }
