...
namespace HttpServer.Resources
{
    ...
    /// </remarks>
    public class EmbeddedResources : IResourceLoader
    {
        private readonly ILogger _logger = LogFactory.CreateLogger(typeof (EmbeddedResources));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddedResources"/> class.
        /// </summary>
        ...
        public EmbeddedResources(string path, Assembly assembly, string nameSpace)
        {
