...
namespace MediaBrowser.Library.Entities
{
    public class MediaInfoData
    {
        ...
        protected static Dictionary<string, string> AudioImageNames = new Dictionary<string, string>() {
            ...
            {"truehd 5 / 6","DDTrueHD_50"},
            {"truehd 6 / 6","DDTrueHD_51"},
            {"truehd 7 / 6","DDTrueHD_61"},
            {"truehd 8 / 6","DDTrueHD_71"},
            ...
            {"dts 96/24 6 / 6","DTS_9624_51"},
            {"dts 96/24 / core 6","DTS_9624_51"},
            {"dts 96/24 / core 6 / 6","DTS_9624_51"},
            {"dts es 6","DTS_ES_51"},
            {"dts es 7","DTS_ES_61"},
            {"dts es 6 / 6","DTS_ES_51"},
            {"dts es 7 / 6","DTS_ES_61"},
            {"dts es / core 6","DTS_ES_51"},
            {"dts es / core 7","DTS_ES_61"},
            {"dts es / core 6 / 6","DTS_ES_51"},
            {"dts es / core 7 / 6","DTS_ES_61"},
            {"dts hra 6","DTS_HD_HRA_51"},
            {"dts hra 7","DTS_HD_HRA_61"},
            {"dts hra 8","DTS_HD_HRA_71"},
            {"dts hra 6 / 6","DTS_HD_HRA_51"},
            {"dts hra 7 / 6","DTS_HD_HRA_61"},
            {"dts hra 8 / 6","DTS_HD_HRA_71"},
            {"dts hra / core 6","DTS_HD_HRA_51"},
            {"dts hra / core 7","DTS_HD_HRA_61"},
            {"dts hra / core 8","DTS_HD_HRA_71"},
            {"dts hra / core 6 / 6","DTS_HD_HRA_51"},
            {"dts hra / core 7 / 6","DTS_HD_HRA_61"},
            {"dts hra / core 8 / 6","DTS_HD_HRA_71"},
            ...
            {"dts ma 3 / 6","DTS_HD_MA_30"},
            {"dts ma 4 / 6","DTS_HD_MA_40"},
            {"dts ma 5 / 6","DTS_HD_MA_50"},
            {"dts ma 6 / 6","DTS_HD_MA_51"},
            {"dts ma 7 / 6","DTS_HD_MA_61"},
            {"dts ma 8 / 6","DTS_HD_MA_71"},
            {"dts ma / core 3","DTS_HD_MA_30"},
            {"dts ma / core 4","DTS_HD_MA_40"},
            {"dts ma / core 5","DTS_HD_MA_50"},
            {"dts ma / core 6","DTS_HD_MA_51"},
            {"dts ma / core 7","DTS_HD_MA_61"},
            {"dts ma / core 8","DTS_HD_MA_71"},
            {"dts ma / core 3 / 6","DTS_HD_MA_30"},
            {"dts ma / core 4 / 6","DTS_HD_MA_40"},
            {"dts ma / core 5 / 6","DTS_HD_MA_50"},
            {"dts ma / core 6 / 6","DTS_HD_MA_51"},
            {"dts ma / core 7 / 6","DTS_HD_MA_61"},
            {"dts ma / core 8 / 6","DTS_HD_MA_71"},
            {"dts 96/24","DTS_9624"},
            {"dts 96/24 / Core","DTS_9624"},
            {"dts es","DTS_ES"},
            {"dts es / Core","DTS_ES"},
            {"dts hra","DTS_HD_HRA"},
            {"dts hra / core","DTS_HD_HRA"},
            {"dts ma","DTS_HD_MA"},
            {"dts ma / core","DTS_HD_MA"},			
            {"dts","Dts"},
            {"wma","Wma"},
            {"wma2","Wma"},
            {"wma3","Wma"},
